    ...
    resultsDiv.innerHTML = `
        <div class="recipe-card fade-in">
            ...
            <div class="recipe-actions">
                ...
                <button class="btn btn-secondary" onclick="saveRecipe('${recipe.name}')">❤️ Save to Favorites</button>
                <button class="btn btn-outline" onclick="rateRecipe('${recipe.name}')">⭐ Rate Recipe</button>
            </div>
        </div>
    `;
